...
/* Nouveaux compteurs pour les unités de répression (à créer plus tard) */
let breakers = 0;    // casseurs
let agitators = 0;   // agitateurs

/* Tableau pour stocker les actions malus depuis un JSON externe */
let malusActions = [];
fetch("malus.json")
  ...
  .catch(function(error) {
    console.error("Erreur de chargement du JSON malus:" + error);
  });
...
function resetGame() {
  ...
  autoClickIntervals.forEach(function(interval) {
